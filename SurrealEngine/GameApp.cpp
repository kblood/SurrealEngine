...
int GameApp::main(Array<std::string> args)
{
	...
	try
	{
		...
		{
			std::cout << "SurrealEngine [--url=<mapname>] [--engineversion=X] [--autoplay] [--probexr] [--debugstereo] [--botbench[=scenario]] [--botbench-output=dir] [--botbench-seed=N] [--botbench-ticks=N] [--botbench-skill=0..7] [--botbench-bot-name=name] [--botbench-bot-names=name0,name1] [--botbench-fixture=id] [Path to game folder]\n";
