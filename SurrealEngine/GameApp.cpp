...
int GameApp::main(Array<std::string> args)
{
	...
	try
	{
		...
		{
			std::cout << "SurrealEngine [--url=<mapname>] [--engineversion=X] [--autoplay] [--probexr] [--debugstereo] [--vr] [--vr-lefthand] [--debugvrhands] [--debugvrfire] [--debugvrtwohand] [Path to game folder]\n";
			return 0;
		}
