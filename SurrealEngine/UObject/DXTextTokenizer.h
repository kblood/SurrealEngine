...
class DXTextTokenizer
{
public:
	static bool Next(const std::string& source, size_t& position, const std::string& playerName, const std::string& playerFirstName, DXTextToken& token);
...
private:
	...
	static DXTextTokenColor ParseColor(const std::string& payload);
	static void ParseFile(const std::string& payload, DXTextToken& token);
	static void ParseEmail(const std::string& payload, DXTextToken& token);
