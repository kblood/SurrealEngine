...
{
public:
	// Player-facing avatar presentation. Off by default and enabled only by
	// the launcher's VR settings. Unlike diagnostics, this draws the avatar at
	// the player's real position and culls the head for first-person viewing.
