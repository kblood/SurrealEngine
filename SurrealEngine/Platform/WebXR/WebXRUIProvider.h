...
#pragma pack(pop)
	...
	std::array<XRUICanvasCaptureDescriptor, 4> BuildDirectUICaptureDescriptors(
		float worldUnitsPerMeter, const PerViewHudPresentation& hud,
		int pixelWidth, int pixelHeight, int canvasScale);
