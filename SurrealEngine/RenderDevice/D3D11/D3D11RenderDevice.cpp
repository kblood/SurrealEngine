...
void D3D11RenderDevice::Exit()
{
	...
	if (DebugLayer)
	{
		DebugLayer->ReportLiveDeviceObjects(/*D3D11_RLDO_SUMMARY |*/ ((D3D11_RLDO_FLAGS)0x2)/*D3D11_RLDO_DETAIL*/ | ((D3D11_RLDO_FLAGS)0x4)/*D3D11_RLDO_IGNORE_INTERNAL*/);
		PrintDebugLayerMessages();
	}
...
void D3D11RenderDevice::SetSceneNode(FSceneNode* Frame)
{
	...
	SceneConstants.ObjectToProjection = objectToProjection * Frame->WorldToView * Frame->ObjectToWorld;
