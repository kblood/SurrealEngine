...
int main()
{
	...
	HazardResidenceUpdate update = AdvanceHazardResidence({}, true, true, 87,
		0.1f, false, false, 0.25f);
	Check(update.Started && update.State.Active && update.State.EntryHealth == 87
		&& update.State.HarmfulSeconds == 0.1f,
	...
	update = AdvanceHazardResidence(update.State, false, true, 87, 0.1f, false, false, 0.25f);
	...
	update = AdvanceHazardResidence(update.State, true, true, 87, 0.1f, false, false, 0.25f);
	...
	update = AdvanceHazardResidence(update.State, false, true, 87, 0.25f, false, false, 0.25f);
	...
	update = AdvanceHazardResidence({}, true, true, 100, 0.1f, false, false, 0.25f);
	update = AdvanceHazardResidence(update.State, true, false, 0, 0.0f, false, false, 0.25f);
	Check(update.Terminal == HazardResidenceTerminal::Death,
		"death terminates an active residence rather than counting clearance");
	update = AdvanceHazardResidence({}, true, true, 100, 0.1f, false, false, 0.25f);
	update = AdvanceHazardResidence(update.State, true, true, 100, 0.0f, true, false, 0.25f);
	Check(update.Terminal == HazardResidenceTerminal::LifeBoundary,
		"life boundary is a distinct censor");
	update = AdvanceHazardResidence({}, true, true, 100, 0.1f, false, false, 0.25f);
	update = AdvanceHazardResidence(update.State, true, true, 100, 0.0f, false, true, 0.25f);
	Check(update.Terminal == HazardResidenceTerminal::RunEnd,
		"run end is a distinct censor");
	update = AdvanceHazardResidence({}, true, true, 100, std::nanf(""), false, false, 0.25f);
