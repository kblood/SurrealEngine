if(NOT DEFINED SOURCE_ROOT OR NOT DEFINED OUTPUT_FILE OR NOT DEFINED GIT_EXECUTABLE OR
		NOT DEFINED COMPILER_EXECUTABLE OR NOT BROWSER_ENTRY_POINT MATCHES "^(call-main|asyncify-opfs)$" OR
		NOT RELEASE_PROFILE MATCHES "^(diagnostic|production)$")
	message(FATAL_ERROR "Browser build provenance requires source/toolchain fields and a supported browser entry point")
endif()

foreach(boolean_name IN ITEMS USE_PTHREADS WASMFS_OPFS WASMFS_OPFS_ASYNCIFY PROXY_TO_PTHREAD WEBGL2_RENDERER)
	if(${boolean_name})
		set(${boolean_name}_JSON true)
	else()
		set(${boolean_name}_JSON false)
	endif()
endforeach()
if(RELEASE_PROFILE STREQUAL "production")
	set(assertions 0)
	set(stack_overflow_check 0)
else()
	set(assertions 2)
	set(stack_overflow_check 2)
endif()
if(USE_PTHREADS)
	set(pthread_pool_size 2)
else()
	set(pthread_pool_size 0)
endif()
...
set(contents "{\n")
string(APPEND contents "  \"schema\": \"surrealengine-browser-build-provenance-v2\",\n")
...
string(APPEND contents "  \"buildType\": \"${BUILD_TYPE}\",\n")
string(APPEND contents "  \"releaseProfile\": \"${RELEASE_PROFILE}\",\n")
string(APPEND contents "  \"assertions\": ${assertions},\n")
string(APPEND contents "  \"stackOverflowCheck\": ${stack_overflow_check},\n")
string(APPEND contents "  \"initialMemoryBytes\": 268435456,\n")
string(APPEND contents "  \"allowMemoryGrowth\": true,\n")
string(APPEND contents "  \"threads\": ${USE_PTHREADS_JSON},\n")
string(APPEND contents "  \"pthreadPoolSize\": ${pthread_pool_size},\n")
string(APPEND contents "  \"wasmfsOpfs\": ${WASMFS_OPFS_JSON},\n")
string(APPEND contents "  \"wasmfsOpfsAsyncify\": ${WASMFS_OPFS_ASYNCIFY_JSON},\n")
string(APPEND contents "  \"proxyToPthread\": ${PROXY_TO_PTHREAD_JSON},\n")
string(APPEND contents "  \"webgl2Renderer\": ${WEBGL2_RENDERER_JSON},\n")
